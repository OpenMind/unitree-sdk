...
class ChargingStatus(BaseModel):
    ...
    battery_soc: float = Field(..., description="Battery state of charge")
    battery_current: float = Field(..., description="Battery current")
    dock_process_running: bool = Field(..., description="Whether dock process is running")
    charging_confirmation_pending: bool = Field(..., description="Whether charging confirmation is pending")
